    ...
    <form action="guardarRude.php" method="post" onsubmit="javascript:return false;if(confirm('¿Esta seguro de Guardar los Datos?'))">
        ...
        <div class="cuerpo">
	    	<table class="tablaSB">
                ...
                <tr><td>Localidad</td><td>::</td><td><input type="text" name="localidadNacA" value="NUESTRA SEÑORA DE LA PAZ" size="37"/></td></tr>
                <tr><td>Oficialia Nº</td><td>::</td><td><input type="text" name="oficialiaA" size="37"/></td></tr>
                <tr><td>Libro Nº</td><td>::</td><td><input type="text" name="libroA" size="37"/></td></tr>
                <tr><td>Partida Nº</td><td>::</td><td><input type="text" name="partidaA" size="37"/></td></tr>
                <tr><td>Folio Nº</td><td>::</td><td><input type="text" name="folioA" size="37"/></td></tr>
        	</table>
        </div>
        ...
        <div class="cuerpo">
	    	<table class="tablaSB">
    	    	...
    	    	<tr><td>Codigo SIE, Colegio Anterior</td><td>::</td><td><input type="text" name="codigoSIEA" value=""  size="37"/></td></tr>
                <tr><td>Nombre Colegio Anterior</td><td>::</td><td><input type="text" name="unidadEducativaA" value=""  size="37"/></td></tr>
        	</table>
        </div>
        <div class="titulo">Dirección Actual del Estudiante</div>
        <div class="cuerpo">
	    	<table class="tablaSB">
    	    	<tr><td>Provincia</td><td>::</td><td><input type="text" name="provinciaA" value="MURILLO"  size="37"/></td></tr>
                <tr><td>Sección</td><td>::</td><td><input type="text" name="seccionA" value="CUARTA SECCIÓN" size="37"/></td></tr>
                <tr><td>Localidad</td><td>::</td><td><input type="text" name="localidadA" value="EL ALTO - CIUDAD EL ALTO" size="37"/></td></tr>
                <tr><td>Zona</td><td>::</td><td><input type="text" name="zonaA" value="<?php echo mb_strtoupper($alu['Zona'],"utf8");?>" size="37"/></td></tr>
                <tr><td>Calle</td><td>::</td><td><input type="text" name="calleA" value="<?php echo mb_strtoupper($alu['Calle'],"utf8");?>" size="37"/></td></tr>
                <tr><td>Numero</td><td>::</td><td><input type="text" name="numeroViviendaA" value="<?php echo mb_strtoupper($alu['Numero'],"utf8");?>" size="37"/></td></tr>
                <tr><td>Teléfono</td><td>::</td><td><input type="text" name="telefonoA" value="<?php echo mb_strtoupper($alu['TelefonoCasa'],"utf8");?>" size="37"/></td></tr>
                <tr><td>Celular</td><td>::</td><td><input type="text" name="celularA" value="<?php echo mb_strtoupper($alu['Celular'],"utf8");?>" size="37"/></td></tr>
        	</table>
        </div>
        ...
        <div class="cuerpo">
	    	<table class="tablaSB">
                ...
                <tr><td>Lengua Materna</td><td>::</td><td><input type="text" name="lenguaMaterna" value="CASTELLANO" /></td></tr>
                ...
                <tr><td>¿El estudiante tiene acceso a Internet?</td><td>::</td><td>
                    ¿Internet en casa?<select name="internet" id="internet">
